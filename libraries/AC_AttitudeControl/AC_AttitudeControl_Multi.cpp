...
const AP_Param::GroupInfo AC_AttitudeControl_Multi::var_info[] = {
    ...
    AP_SUBGROUPINFO(_npid_rate_pitch, "NEF_PIT_", 7, AC_AttitudeControl_Multi, AC_NPID),
    // @Param: RAT_RLL_FILT
...
AC_AttitudeControl_Multi::AC_AttitudeControl_Multi(AP_AHRS_View &ahrs, const AP_Vehicle::MultiCopter &aparm, AP_MotorsMulticopter& motors, float dt) :
    ...
    _npid_rate_pitch(AC_ATC_MULTI_RATE_RP_P, AC_ATC_MULTI_RATE_RP_I, AC_ATC_MULTI_RATE_RP_D, 0.0f, AC_ATC_MULTI_RATE_RP_IMAX, 0.0f,0.0f,0.0f,AC_ATC_MULTI_RATE_RP_FILT_HZ, 0.0f, AC_ATC_MULTI_RATE_RP_FILT_HZ, dt)
{
...
void AC_AttitudeControl_Multi::rate_controller_run()
{
    ...
    _motors.set_pitch(get_rate_pitch_npid().update_all(_rate_target_ang_vel.y, gyro_latest.y, _motors.limit.pitch) + _actuator_sysid.y);
    _motors.set_pitch_ff(get_rate_pitch_npid().get_ff());
