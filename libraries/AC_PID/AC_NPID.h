...
public:
    ...
    // Constructor for PID
    AC_NPID(float initial_p, float initial_i, float initial_d, float initial_ff, float initial_imax,float initial_alpha_P,float initial_alpha_D,float initial_delta,float initial_filt_T_hz, float initial_filt_E_hz, float initial_filt_D_hz, float dt);
    ...
    void operator()(float p_val, float i_val, float d_val, float ff_val, float imax_val,float alpha_P_val,float alpha_D_val,float delta_val,float input_filt_T_hz, float input_filt_E_hz, float input_filt_D_hz, float dt);
